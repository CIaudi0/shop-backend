...
Product.create!([
  { title: "MacBook Pro 16",
    ...
    price: 2499.00, original_price: 2899.00, sale: true, stock: 5,
  ...
  { title: "Cuffie Sony WH-1000XM5",
    ...
    price: 349.90, original_price: 420.00, sale: true, stock: 12,
  ...
  { title: "Tastiera Meccanica RGB",
    ...
    price: 89.99, original_price: 89.99, sale: false, stock: 30,
  ...
  { title: "Fotocamera FujiFilm X-T5",
    ...
    price: 1699.00, original_price: 1850.00, sale: true, stock: 3,
  ...
  { title: "Smartwatch Ultra",
    ...
    price: 799.00, original_price: 899.00, sale: true, stock: 8,
  ...
  { title: "Mouse Gaming Wireless",
    ...
    price: 59.90, original_price: 79.90, sale: true, stock: 25,
  ...
  { title: "Drone 4K Explorer",
    ...
    price: 450.00, original_price: 450.00, sale: false, stock: 0,
  ...
  { title: "Monitor Curvo 34''",
    ...
    price: 499.00, original_price: 650.00, sale: true, stock: 7,
  ...
  { title: "Zaino Urban Tech",
    ...
    price: 45.00, original_price: 60.00, sale: true, stock: 50,
  ...
  { title: "Occhiali da Sole Classic",
    ...
    price: 120.00, original_price: 120.00, sale: false, stock: 20,
  ...
  { title: "Sneakers Limited Edition",
    ...
    price: 180.00, original_price: 250.00, sale: true, stock: 0,
  ...
  { title: "Orologio Minimalista",
    ...
    price: 135.00, original_price: 135.00, sale: false, stock: 15,
  ...
  { title: "Lampada da Scrivania LED",
    ...
    price: 35.00, original_price: 50.00, sale: true, stock: 40,
  ...
  { title: "Macchina Caffè Espresso",
    ...
    price: 199.00, original_price: 250.00, sale: true, stock: 10,
  ...
  { title: "Pianta Grassa in Vaso",
    ...
    price: 19.90, original_price: 19.90, sale: false, stock: 100,
  ...
  { title: "Set Profumazione Ambiente",
    ...
    price: 24.90, original_price: 35.00, sale: true, stock: 60,
